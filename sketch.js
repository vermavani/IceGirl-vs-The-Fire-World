...
function preload(){
 ...
 //sounds
  ...
  arrowSound = loadSound("sounds/arrow.wav")
  monsterSound = loadSound("sounds/monster.wav")
  burnSound = loadSound("sounds/burn.wav")
  explosionSound = loadSound("sounds/explosion.wav")
  happySound = loadSound("sounds/happy.wav")
  lostSound = loadSound("sounds/lost.wav")
  overSound = loadSound("sounds/over.wav")
  jumpSound = loadSound("sounds/jump.wav")
  splashSound = loadSound("sounds/splash.wav")
...
function setup() {
  ...
  fire1.visible = false;
  fire1.scale = 0.7;
  fire1.setCollider("rectangle",-5,50,fire1.width-150,fire1.height-150);
  //fire1.debug = true
  ...
  fire2.visible = false;
  fire2.scale = 0.8;
  fire2.setCollider("rectangle",-5,50,fire2.width-150,fire2.height-120);
  //fire2.debug = true
  ...
  fire3.visible = false;
  fire3.scale = 0.4;
  fire3.setCollider("rectangle",-5,60,fire3.width-150,fire3.height-100);
  //fire3.debug = true
 ...
 //block5
  ...
  diamond.setCollider("rectangle",-5,50,diamond.width-280,diamond.height-130);
  diamond.debug = true
 
  diamond1 = createSprite(360,270,1600,10);
  diamond1.addImage(diamondI)
  diamond1.scale = 0.3;
  diamond1.visible = false;
  diamond1.setCollider("rectangle",-5,50,diamond1.width-280,diamond1.height-130);
  diamond1.debug = true

  diamond2 = createSprite(330,240,1600,10);
  diamond2.addImage(diamondI)
  diamond2.scale = 0.4;
  diamond2.visible = false;
  diamond2.setCollider("rectangle",-5,50,diamond2.width-280,diamond2.height-130);
  diamond2.debug = true

  diamond3 = createSprite(630,140,1600,10);
  diamond3.addImage(diamondI)
  diamond3.scale = 0.4;
  diamond3.visible = false;
  diamond3.setCollider("rectangle",-5,50,diamond3.width-250,diamond3.height-130);
  diamond3.debug = true

  diamond4 = createSprite(890,300,1600,10);
  diamond4.addImage(diamondI)
  diamond4.scale = 0.5;
  diamond4.visible = false;
  diamond4.setCollider("rectangle",-5,50,diamond4.width-250,diamond4.height-130);
  diamond4.debug = true
  ...
  fireGirl.setCollider("rectangle",-5,50,fireGirl.width-130,fireGirl.height-100);
  //fireGirl.debug = true
  ...
  fireGirl2.setCollider("rectangle",-5,50,fireGirl.width-160,fireGirl.height-120);
...
function draw() {
  ...
  if(gameState === 1){
    ...
    if(waterGirl.isTouching(diamond1)){
    
      diamond1.destroy()
      score = score + 5;
      CollectSound.play()
    }
    if(waterGirl.isTouching(diamond)){
    ...
    if(waterGirl.isTouching(block6)){
      ...
      waterGirl.collide(block9)
          ...
          if(waterGirl.isTouching(diamond2)){
      
            diamond2.destroy()
            score = score + 5;
             CollectSound.play()
           }
           if(waterGirl.isTouching(diamond3)){
      
            diamond3.destroy()
            score = score + 5;
             CollectSound.play()
           }
           if(waterGirl.isTouching(diamond4)){
          ...
          waterGirl.bounceOff(edges[1])
            ...
            textSize(40)
            fill("WHITE")
            text(" Scroll to move UP and DOWN!",50,490);
